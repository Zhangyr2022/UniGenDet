...
def generate_image(prompt, num_timesteps=50, cfg_scale=10.0, cfg_interval=[0, 1.0], cfg_renorm_min=0., timestep_shift=1.0, num_images=4, resolution=512, device=None): # device
...
if __name__ == "__main__":
    ...
    print("total prompts:", total_metadatas)
