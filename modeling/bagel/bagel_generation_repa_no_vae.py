...
class BagelGenerationREPA(PreTrainedModel):
    ...
    def forward(
        ...
        if (
            ...
            vit_tokens_det = det_repa_hidden_states[sequence_status['packed_vit_token_indexes']]
            ...
            for i, tokens in enumerate(split_vit_tokens_det):
                ...
                h_vae, w_vae = patchified_vae_latent_shapes[i]
