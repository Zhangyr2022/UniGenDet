    ...
    def forward_diga(
        ...
        for i,decoder_layer in enumerate(self.layers):
            ...
            if i == DIGA_LAYER-1:
                if diga_layer_break:
                    ...
                    diga_hidden_states = packed_sequence.clone()
        ...
        if self.use_moe:
            ...
            if diga_layer_break:
                ...
                return diga_hidden_states, packed_sequence_
        else:
            if diga_layer_break:
                return self.norm(packed_sequence)
            else:
                return diga_hidden_states, self.norm(packed_sequence)
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel):
    ...
    def forward_diga(self, *args, **kwargs):
        return self.model.forward_diga(*args, **kwargs)
